...
class SellRPController extends GetxController {
  ...
  Future<void> loadSellData() async {
    try {
      ...
      sellData.value = res;
      walletBalance.value = res.balance.availableRp.toDouble();
      ...
      log("_sell_rp_controller: $e");
      log("_sell_rp_controller: $stk");
      Get.snackbar("Error", "Failed to load Sell RP data");
    } finally {
