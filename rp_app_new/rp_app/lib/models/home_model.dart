...
class BankInfo {
  ...
  BankInfo({required this.hasBank, this.message, required this.accounts});
...
class BankAccount {
  ...
  factory BankAccount.fromJson(Map<String, dynamic> json) {
    return BankAccount(
      ...
      holder: _parseString(json['account_holder']),
...
class BannerModel {
  ...
  factory BannerModel.fromJson(Map<String, dynamic> json) {
    return BannerModel(id: json['id'] ?? 0, image: json['image'] ?? "");
  }
}
