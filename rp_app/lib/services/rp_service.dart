...
class RPService {
  ...
  Future<SellRPResponse> getSellPageData() async {
    final response = await _apiService.get("/rp/sell-page");
  ...
  // =====================================================
  // 🔥 NEW : FETCH UPI DETAILS FOR MANUAL QR/UPI ID PAYMENT
  // =====================================================
  Future<UpiDetailsModel> getUpiDetails() async {
    final response = await _apiService.get("/upi/details");
    return UpiDetailsModel.fromJson(response);
  }

  // =====================================================
  // 🔥 NEW : SUBMIT MANUAL PAYMENT REQUEST WITH UTR
  // =====================================================
  Future<Map<String, dynamic>> submitBuyRPRequest({
    required String planId,
...
class UpiDetailsModel {
  ...
  UpiDetailsModel({required this.upiId, required this.qrImage});
