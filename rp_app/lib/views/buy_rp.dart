...
class BuyRPScreen extends StatelessWidget {
  BuyRPScreen({super.key});

  final BuyRPHistoryController controller =
  Get.put(BuyRPHistoryController());
        ...
        child: Column(
          ...
          children: [
            ...
            Row(
              ...
              children: [
                Text(
                  "Payment Amount: ₹${data.paymentAmount.toInt()}",
